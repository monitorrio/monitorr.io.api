...
{
	/// <summary>
	/// Awesome reflection utilities from Structuremap https://github.com/structuremap/structuremap/blob/master/src/StructureMap/TypeExtensions.cs
	/// </summary>
	public static class TypeExtensions
	{
		...
		private static string GetGenericName(Type type) {
			...
			return "{0}<{1}>".Fmt(type.Name.Split('`').First(), parameterList);
		}
