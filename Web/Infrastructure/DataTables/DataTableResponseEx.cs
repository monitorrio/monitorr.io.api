...
{
    public class DataTablesResponseEx : IDataTablesResponse
    {
        /// <summary>
        ...
        private DataTablesResponseEx(int draw, string errorMessage)
        ...
        /// <param name="draw">Draw count from request object.</param>
        /// <param name="errorMessage">Error message.</param>
        private DataTablesResponseEx(int draw, string errorMessage, IDictionary<string, object> additionalParameters)
        {
            Draw = draw;
            Error = errorMessage;
        ...
        private DataTablesResponseEx(int draw, int totalRecords, int totalRecordsFiltered, object data)
        ...
        /// <param name="data">Data object (collection).</param>
        private DataTablesResponseEx(int draw, int totalRecords, int totalRecordsFiltered, object data, IDictionary<string, object> additionalParameters)
        {
            Draw = draw;
        ...
        public static DataTablesResponseEx Create(IDataTablesRequest request, int totalRecords, int totalRecordsFiltered, object data)
        {
        ...
        /// <param name="additionalParameters">Aditional parameters for response.</param>
        /// <returns>The response object.</returns>
        public static DataTablesResponseEx Create(IDataTablesRequest request, int totalRecords, int totalRecordsFiltered, object data, IDictionary<string, object> additionalParameters)
        {
            ...
            return new DataTablesResponseEx(request.Draw, totalRecords, totalRecordsFiltered, data, additionalParameters);
        }
        /// <summary>
        /// Creates a new response instance.
        /// </summary>
        ...
        /// <param name="errorMessage">Error message.</param>
        /// <returns>The response object.</returns>
        public static DataTablesResponseEx Create(IDataTablesRequest request, string errorMessage)
        {
        ...
        /// <param name="errorMessage">Error message.</param>
        /// <returns>The response object.</returns>
        public static DataTablesResponseEx Create(IDataTablesRequest request, string errorMessage, IDictionary<string, object> additionalParameters)
        {
            // When request is null, there should be no response (null response).
            if (request == null) return null;
            ...
            return new DataTablesResponseEx(request.Draw, errorMessage, additionalParameters);
        }
    }
}